"""
Source: https://github.com/basnijholt/nanowire-bandstructures/blob/master/peierls.py
"""

__author__      = "Bas Nijholt"
__copyright__   = "Copyright (c) 2016, Bas Nijholt (TU Delft)"
